...
void main() {
  ...
  vec4 red = tint_TextureLoadMultiplanarExternal(v_58, min(uvec2(ivec2(10)), ((v_58.apparentSize + uvec2(1u)) - uvec2(1u))));
  imageStore(outImage, ivec2(0), red);
  tint_ExternalTextureParams v_59 = v_38(0u);
  vec4 green = tint_TextureLoadMultiplanarExternal(v_59, min(uvec2(ivec2(70, 118)), ((v_59.apparentSize + uvec2(1u)) - uvec2(1u))));
