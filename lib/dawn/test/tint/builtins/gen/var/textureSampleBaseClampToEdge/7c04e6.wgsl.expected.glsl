...
vec4 textureSampleBaseClampToEdge_7c04e6() {
  ...
  tint_ExternalTextureParams v_54 = v_34(0u);
  vec4 res = tint_TextureSampleClampToEdgeMultiplanarExternal(v_54, arg_2);
  return res;
}
void main() {
...
vec4 textureSampleBaseClampToEdge_7c04e6() {
  vec2 arg_2 = vec2(1.0f);
  tint_ExternalTextureParams v_53 = v_33(0u);
  vec4 res = tint_TextureSampleClampToEdgeMultiplanarExternal(v_53, arg_2);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_54 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_54.pos = vec4(0.0f);
  v_54.prevent_dce = textureSampleBaseClampToEdge_7c04e6();
  return v_54;
}
void main() {
