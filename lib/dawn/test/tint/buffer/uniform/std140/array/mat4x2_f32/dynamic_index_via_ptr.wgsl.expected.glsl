...
void main() {
  ...
  vec2 l_a_i_i = uintBitsToFloat(mix(v_16.xy, v_16.zw, bvec2(((((v_14 + v_15) & 15u) >> 2u) == 2u))));
  uvec4 v_17 = v.inner[((v_14 + v_15) / 16u)];
  v_1.inner = (((uintBitsToFloat(v_17[(((v_14 + v_15) & 15u) >> 2u)]) + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
