...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    ...
    vec4 v_15 = texelFetch(t_f_plane0, v_14, int(0u));
    v_12 = v_15.xyz;
    v_13 = v_15.w;
  } else {
    ivec2 v_16 = ivec2(v_11);
    float v_17 = texelFetch(t_f_plane0, v_16, int(0u)).x;
    ivec2 v_18 = ivec2(uvec2((v_10 * params.plane1CoordFactor)));
    v_12 = (vec4(v_17, texelFetch(t_f_plane1, v_18, int(0u)).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_13 = 1.0f;
  }
  vec3 v_19 = v_12;
  vec3 v_20 = vec3(0.0f);
...
void main() {
  ...
  vec4 vals = tint_TextureLoadMultiplanarExternal(v_58, min(uvec2(ivec2(0)), ((v_58.apparentSize + uvec2(1u)) - uvec2(1u))));
}
