...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_59, min(uvec2(ivec2(1)), ((v_59.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_58, min(uvec2(ivec2(1)), ((v_58.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_59 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_59.pos = vec4(0.0f);
  v_59.prevent_dce = textureLoad_8acf41();
  return v_59;
}
void main() {
