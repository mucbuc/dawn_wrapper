...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_59, min(uvec2(arg_1), ((v_59.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_58, min(uvec2(arg_1), ((v_58.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
