...
void main_inner(uint idx) {
  ...
  uint4 v_28 = ub[((16u + (idx * 544u)) / 16u)];
  float2 vec2_f32 = asfloat(((((((16u + (idx * 544u)) & 15u) >> 2u) == 2u)) ? (v_28.zw) : (v_28.xy)));
  uint4 v_29 = ub[((24u + (idx * 544u)) / 16u)];
  int2 vec2_i32 = asint(((((((24u + (idx * 544u)) & 15u) >> 2u) == 2u)) ? (v_29.zw) : (v_29.xy)));
  uint4 v_30 = ub[((32u + (idx * 544u)) / 16u)];
  uint2 vec2_u32 = ((((((32u + (idx * 544u)) & 15u) >> 2u) == 2u)) ? (v_30.zw) : (v_30.xy));
